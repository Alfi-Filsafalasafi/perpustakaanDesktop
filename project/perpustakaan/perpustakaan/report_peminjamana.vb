...
Public Class report_peminjamana
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perpustakaan.report_peminjamana.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_peminjamana
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_peminjamana = New report_peminjamana()
        rpt.Site = Me.Site
        Return rpt
    End Function
